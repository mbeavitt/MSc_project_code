...
qsub -cwd -l h_vmem=4G -pe sharedmem 1 -sync y /home/s1653324/Code/RNAseq/array/array-job.sh /home/s1653324/Code/RNAseq/array/cutadapt-run.sh

echo "Running fastqc... (second run)"
qsub -cwd -l h_vmem=4G -pe sharedmem 4 -sync y /home/s1653324/Code/RNAseq/array/array-job.sh /home/s1653324/Code/RNAseq/array/fastqc-run.sh

echo "Unzipping files..."
qsub -cwd -l h_vmem=200M -pe sharedmem 1 -sync y /home/s1653324/Code/RNAseq/array/array-job.sh /home/s1653324/Code/RNAseq/array/un-gz.sh

echo "Concatenating lanes..."
qsub -cwd -l h_vmem=200M -pe sharedmem 1 -sync y /home/s1653324/Code/RNAseq/array/array-job.sh /home/s1653324/Code/RNAseq/array/cat_files.sh
